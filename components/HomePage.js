    ...
    <div className="w-full mx-auto px-4 py-8 bg-white">
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between gap-8 mb-16">
        <div className="text-center lg:text-left lg:max-w-md">
          <h3 className="text-xl font-semibold text-blue-500">New Arrival</h3>
      ...
      <section className="text-center mb-16">
        <h2 className="text-2xl font-bold">Trending Websites on Markets</h2>
        <p className="text-gray-500 mt-2">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
        <div className="flex justify-around mt-6 text-blue-500 font-semibold">
      ...
      <section className="mb-16">
        ...
        <button className="block mx-auto mt-6 px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
          Show More
        </button>
      </section>
      ...
      <section className="text-center mb-16">
        <h2 className="text-2xl font-bold">50+ Premium Website</h2>
        <p className="text-gray-500 mt-2">
      ...
      {/* Our Works Section */}
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-center">Our Works</h2>
